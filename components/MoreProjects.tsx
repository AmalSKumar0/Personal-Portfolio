        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          <div>
            ...
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-serif text-gray-900 dark:text-white font-bold italic mt-3 tracking-tight leading-tight">
              More <span className="text-transparent bg-clip-text bg-gradient-to-r from-neon-purple to-neon-cyan dark:from-neon-purple dark:to-lavender-300 not-italic font-sans font-extrabold">Projects</span>
            </h2>
          </div>
