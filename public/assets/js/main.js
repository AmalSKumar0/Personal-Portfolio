...
$(function () {
    ...
    ***************************/
    ...
    window.initAshley = function () {
        // Clear any existing ScrollTriggers to avoid duplication on re-init
        ...
        ***************************/
        ...
        if (!window.ashleyPreloaderRan) {
            window.ashleyPreloaderRan = true;
            ...
            gsap.set(".mil-preloader", { opacity: 0, display: 'none' });

            // Mimic the "onComplete" effect for content appearance if needed, 
            // but ScrollTrigger (below) also handles initial state. 
            // However, to be safe and ensure content isn't stuck at opacity:0 
            // if it was waiting for the preloader timeline:
            gsap.to(".mil-up", 0.4, {
                y: 0,
                opacity: 1,
                scale: 1,
        ...
        ***************************/
        // Clear before appending to avoid duplication
        ...
        ***************************/
        ...
        menus.forEach((menu) => {
            ...
            if (menu.parentNode) {
                ...
                newMenu.addEventListener("click", () => toggleMenu(newMenu));
            }
        });
