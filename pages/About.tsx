                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                    ...
                    <div className="space-y-12">
                        <ScrollFade direction="up" delay={0.15}>
                            <section className="bg-white/80 dark:bg-white/5 p-8 rounded-3xl border border-gray-100 dark:border-white/10 backdrop-blur-md shadow-xl">
                    ...
                    <div className="space-y-12">
                        ...
                        <ScrollFade direction="up" delay={0.3}>
                            <section className="p-8 rounded-3xl bg-gradient-to-br from-neon-blue/10 to-neon-purple/10 border border-neon-blue/20 backdrop-blur-md text-center">
