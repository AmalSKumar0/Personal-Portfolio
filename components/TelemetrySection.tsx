               ...
               <div className="h-16 border-b border-slate-100 flex items-center justify-between px-6 sm:px-8 bg-white/50">
                  <div className="flex items-center gap-4">
                     ...
                     <div className="flex items-center gap-2 px-3 py-1 rounded-md bg-slate-50 dark:bg-black/20 border border-slate-200 dark:border-white/10">
                        ...
                        <span className="text-xs font-semibold text-slate-600 dark:text-slate-300 font-mono">amal_portfolio_v2.1</span>
                     </div>
                  </div>
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                        ...
                        <div className="md:col-span-12 grid grid-cols-1 sm:grid-cols-3 gap-6">
                           ...
                           <StatCard
                              ...
                              color="text-amber-600 dark:text-amber-400" bg="bg-amber-50 dark:bg-amber-500/10" border="group-hover:border-amber-200 dark:group-hover:border-amber-500/30"
                           />
                        </div>
                        ...
                        <div className="md:col-span-8 bg-white dark:bg-tech-gray/50 rounded-2xl p-6 border border-slate-100 dark:border-white/5 shadow-sm relative overflow-hidden group hover:shadow-md transition-all">
                           <div className="flex justify-between items-start mb-6">
                              ...
                              <select className="text-xs border border-slate-200 dark:border-white/10 rounded-md px-2 py-1 text-slate-500 dark:text-slate-400 bg-slate-50 dark:bg-black/20 outline-none">
...
const StatCard = ({ icon: Icon, label, value, sub, color, bg, border }) => (
   <div className={`bg-white dark:bg-tech-gray/50 p-5 rounded-2xl border border-slate-100 dark:border-white/5 group transition-all duration-300 hover:-translate-y-1 hover:shadow-lg ${border}`}>
      ...
      <div className="mt-2">
         <div className="text-2xl font-bold text-slate-800 dark:text-white tracking-tight">{value}</div>
         <div className="text-[11px] font-semibold text-slate-400 uppercase tracking-wide mt-1">{label}</div>
         <div className="text-[10px] font-medium text-slate-400 mt-2 pt-2 border-t border-slate-50 dark:border-white/5">{sub}</div>
      </div>
   </div>
);
...
const MilestoneItem = ({ icon: Icon, title, role, year, bg, color }) => (
   <div className="group flex items-center justify-between p-2 rounded-xl hover:bg-slate-50 dark:hover:bg-white/5 transition-colors border border-transparent hover:border-slate-100 dark:hover:border-white/5 cursor-pointer">
      <div className="flex items-center gap-3">
      ...
      <div className="text-[10px] font-bold text-slate-400 bg-slate-100 dark:bg-white/10 px-2 py-1 rounded-md group-hover:bg-white dark:group-hover:bg-transparent group-hover:shadow-sm transition-all">
         {year}
      </div>
   </div>
);