            ...
            >
                ...
                <motion.div className="text-center mb-20" variants={cardVariants}>
                    <h1 className="text-5xl md:text-7xl font-display mb-6 tracking-tight text-gray-900 dark:text-white">
                        My <span className="text-neon-blue drop-shadow-sm">Work</span>
                    </h1>
                    <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto leading-relaxed">
                        A collection of projects demonstrating my expertise in software development, APIs, and scalable architectures.
                    </p>
                </motion.div>
                            ...
                            <div className="p-8 flex flex-col flex-grow">
                                <div className="mb-4 flex flex-wrap gap-2">
                                    {project.tags.slice(0, 3).map(tag => (
                                        <span key={tag} className="text-xs font-semibold px-3 py-1 bg-neon-purple/10 text-neon-blue rounded-full border border-neon-purple/20">
                                            {tag}
                                        </span>
                                    ))}
                                ...
                                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3 group-hover:text-neon-blue transition-colors">
                                    {project.title}
                                </h3>
                                ...
                                <Link
                                    ...
                                    className="inline-flex items-center gap-2 font-bold text-gray-900 dark:text-white hover:text-neon-blue transition-colors mt-auto"
                                >
