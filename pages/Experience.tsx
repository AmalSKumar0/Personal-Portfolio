            ...
            >
                ...
                <div className="space-y-12">
                    {experience.map((exp, idx) => (
                        <ScrollFade key={exp.id} direction="up" delay={idx * 0.1} amount={0.1}>
                            <div className="bg-white/80 dark:bg-white/5 p-8 md:p-10 rounded-3xl border border-gray-100 dark:border-white/10 backdrop-blur-md shadow-xl hover:shadow-2xl transition-all relative overflow-hidden group">
