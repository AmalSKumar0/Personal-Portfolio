        ...
        <section className="bg-cream dark:bg-tech-black py-24 px-6 transition-colors duration-300">
            ...
            >
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-24">
                    <motion.div
                        className="bg-[#111] rounded-[2rem] p-10 text-white flex flex-col justify-between min-h-[240px] group cursor-pointer transition-transform hover:-translate-y-1 relative overflow-hidden"
                    ...
                    <motion.div
                        className="bg-white dark:bg-tech-gray rounded-[2rem] p-10 border border-gray-100 dark:border-white/10 flex flex-col justify-between min-h-[240px] group cursor-pointer transition-all hover:-translate-y-1"
                        variants={itemVariants}
                    >
                ...
                <div className="bg-[#FAFBFF] dark:bg-tech-gray/20 rounded-[3rem] px-6 py-24 relative overflow-hidden transition-colors duration-300">
                    ...
                    <motion.div className="text-center mb-20 relative z-10" variants={itemVariants}>
                    ...
                    <div className="grid md:grid-cols-3 gap-6 relative z-10">
                        {/* Testimonial 1 */}
                        <motion.div
                            className="bg-white dark:bg-tech-gray/50 p-8 rounded-3xl shadow-sm border border-gray-100 dark:border-white/5 flex flex-col transition-colors"
                            variants={itemVariants}
                        >
