      ...
      <div className="bg-white/90 dark:bg-tech-black/90 backdrop-blur-md border border-gray-100 dark:border-white/10 shadow-sm rounded-full px-4 py-2 md:px-6 md:py-3 flex items-center gap-4 md:gap-12 max-w-4xl mx-auto transition-colors duration-300">
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-medium text-gray-600 dark:text-gray-300 transition-colors duration-300">
          <Link to="/about" onClick={handleLinkClick}>
            <div className="hover:text-neon-blue dark:hover:text-neon-cyan transition-colors cursor-pointer">
              About
            </div>
          </Link>
        ...
        <div className="hidden md:flex items-center gap-4">
          <ThemeToggle />
          <Link to="/contact" onClick={handleLinkClick}>
            <button className="bg-slate-900 dark:bg-white hover:bg-slate-800 dark:hover:bg-gray-200 transition-colors text-white dark:text-tech-black px-5 py-2 rounded-full text-sm font-medium cursor-pointer">
              Hire Me
            </button>
          </Link>
          {onClose && (
            <button
              onClick={onClose}
              className="p-1.5 text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white rounded-full hover:bg-gray-100 dark:hover:bg-white/10 transition-colors cursor-pointer"
              title="Close Menu"
            >
              <X size={18} />
            </button>
        ...
        <div className="md:hidden flex items-center gap-3 ml-auto">
          <ThemeToggle />
          <button
            className="p-1 text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors cursor-pointer"
